...
public class SeeAllMaintenanceAdapter extends RecyclerView.Adapter<SeeAllMaintenanceAdapter.MyViewHolder> {

    Context context;
    List<MaintenanceResponse> maintenanceList;

    public SeeAllMaintenanceAdapter(Context context, List<MaintenanceResponse> maintenanceList) {
