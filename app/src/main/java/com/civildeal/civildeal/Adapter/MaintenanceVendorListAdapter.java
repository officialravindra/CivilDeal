...
public class MaintenanceVendorListAdapter extends RecyclerView.Adapter<MaintenanceVendorListAdapter.MyViewHolder> {

    List<ProfileResponse> vendorList;
    Context context;
    Context applicationContext;

    public MaintenanceVendorListAdapter(List<ProfileResponse> vendorList, Context context) {
        this.vendorList = vendorList;
        this.context = context;
    }

    public MaintenanceVendorListAdapter(Context applicationContext, List<ProfileResponse> vendorList) {
    ...
    @NonNull
    @Override
    public MaintenanceVendorListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.vendor_list,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MaintenanceVendorListAdapter.MyViewHolder holder, int position) {
        ...
        Picasso.get()
                ...
                .into(holder.image);
        holder.maintenanceName.setText(vendorList.get(position).getCompanyName());
...
//        holder.desc.setText(vendorList.get(position).getVendorType());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView maintenanceName,name,desc,experience,location;
        ImageView image;
        CardView cardView;
        Button view;
        ...
        public MyViewHolder( View itemView) {
            ...
            maintenanceName=itemView.findViewById(R.id.serviceProductName);
