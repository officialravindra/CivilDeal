...
public class ServiceVendorListsAdapter extends RecyclerView.Adapter<ServiceVendorListsAdapter.MyViewHolder> {

    List<ProfileResponse> vendorList;
    Context context;
    Context applicationContext;

    public ServiceVendorListsAdapter(List<ProfileResponse> vendorList, Context context) {
        this.vendorList = vendorList;
        this.context = context;
    }

    public ServiceVendorListsAdapter(Context applicationContext, List<ProfileResponse> vendorList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Picasso.get()
                ...
                .into(holder.image);
        holder.serviceProductname.setText(vendorList.get(position).getCompanyName());
        holder.name.setText(vendorList.get(position).getServiceProuductName());
//        holder.desc.setText(vendorList.get(position).getVendorType().trim());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView serviceProductname,name,desc,experience,location;
        ImageView image;
        CardView cardView;
        Button view;
        ...
        public MyViewHolder( View itemView) {
            ...
            serviceProductname=itemView.findViewById(R.id.serviceProductName);
