...
public class UpdateLeadByPromoter extends AppCompatActivity {
    ...
    String subCategory,typename,lead_id;
    CardView cardView;
    TextView selecttype;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_lead_by_promoter);
...
//                    Toast.makeText(getContext(), "null", Toast.LENGTH_SHORT).show();
        ...
        ArrayAdapter typeAdapter = new ArrayAdapter(UpdateLeadByPromoter.this, android.R.layout.simple_spinner_item,type);
...
//            }
        ...
        subcategoryspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(UpdateLeadByPromoter.this, "type "+typename, Toast.LENGTH_SHORT).show();
...
//        Toast.makeText(this, ""+typename, Toast.LENGTH_SHORT).show();
    ...
    private void getServiceList() {
        ProgressDialog progressDialog = new ProgressDialog(UpdateLeadByPromoter.this);
...
//                        Toast.makeText(getActivity(), "Success", Toast.LENGTH_SHORT).show();
                        try {
                            ...
                            for (int i = 0; i < cityList.size(); i++) {
                                ...
                                {
                                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(UpdateLeadByPromoter.this, android.R.layout.simple_spinner_item, names);
...
//                    Toast.makeText(UpdateLeadByPromoter.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==android.R.id.home){
            Intent intent = new Intent(UpdateLeadByPromoter.this, MainActivity.class);
